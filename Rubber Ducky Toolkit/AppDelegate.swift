//
//  AppDelegate.swift
//  Rubber Ducky Toolkit
//
//  Created by David Seyboth on 03/02/2017.
//  Copyright © 2017 David Seyboth. All rights reserved.
//
...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "Rubber_Ducky_Toolkit", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        if failError == nil {
            ...
            let url = self.applicationDocumentsDirectory.appendingPathComponent("Rubber_Ducky_Toolkit.storedata")
            do {
